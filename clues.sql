...
SELECT name 
FROM cities 
WHERE cities.countrycode = (SELECT code FROM countries WHERE countries.name = 'San Marino') 
AND NOT cities.name = 'San Marino';
...
SELECT name 
FROM countries 
WHERE countries.code = (SELECT countrycode FROM cities WHERE name LIKE 'Serra%' 
...
SELECT name 
FROM cities 
WHERE cities.id = (SELECT capital FROM countries WHERE countries.code = (SELECT countrycode FROM cities WHERE name LIKE 'Serra%' AND NOT cities.name = 'Serravalle'));
